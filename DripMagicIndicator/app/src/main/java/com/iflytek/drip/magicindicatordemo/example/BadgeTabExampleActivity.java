...
import com.iflytek.drip.magicindicator.buildins.commonnavigator.titles.badge.BadgeRule;
...
public class BadgeTabExampleActivity extends AppCompatActivity {
    ...
    private  CommonNavigator commonNavigator1=null;
    ...
    private void initMagicIndicator1() {
        ...
        commonNavigator1= new CommonNavigator(this);
        commonNavigator1.setAdapter(new CommonNavigatorAdapter() {
            ...
            public IPagerTitleView getTitleView(Context context, final int index) {
                ...
                if (index != 2) {
                    ...
                    badgeTextView.setText("" + (index + 100));
                ...
                // set badge position
                if (index == 0) {
                    badgePagerTitleView.setXBadgeRule(BadgeAnchor.CONTENT_LEFT, -6);
                    badgePagerTitleView.setYBadgeRule(BadgeAnchor.CONTENT_TOP, 0);
                } else if (index == 1) {
                    badgePagerTitleView.setXBadgeRule(BadgeAnchor.CONTENT_RIGHT, -6);
                    badgePagerTitleView.setYBadgeRule(BadgeAnchor.CONTENT_TOP, 0);
                } else if (index == 2) {
                    badgePagerTitleView.setXBadgeRule(BadgeAnchor.CENTER_X, -3);
                    badgePagerTitleView.setYBadgeRule(BadgeAnchor.CONTENT_BOTTOM, 2);
                }
        ...
        magicIndicator.setNavigator(commonNavigator1);
        LinearLayout titleContainer = commonNavigator1.getTitleContainer(); // must after setNavigator
    ...
    private void testBadge(CommonNavigator commonNavigator) {
        commonNavigator.setPagerTitleViewWithMsgBadge(1, R.layout.simple_count_badge_layout, "" + new Random().nextInt(100));
    }
