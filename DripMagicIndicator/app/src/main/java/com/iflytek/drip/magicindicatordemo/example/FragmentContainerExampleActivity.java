...
import com.iflytek.drip.magicindicator.FragmentsHelper;
...
public class FragmentContainerExampleActivity extends AppCompatActivity {
    ...
    private void initMagicIndicator2() {
        DripMagicIndicator magicIndicator = (DripMagicIndicator) findViewById(R.id.magic_indicator2);
        ...
        DripMagicIndicator.Builder builder=magicIndicator.new Builder();
         builder.setAdjustMode(true)
                ...
                .build();
        magicIndicator.setPagerTitleViewWithMsgBadge(1,""+20);
        magicIndicator.setPagerTitleViewWithMsgBadge(2,""+50);
